contextParser = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c4 = "using",
        peg$c5 = { type: "literal", value: "using", description: "\"using\"" },
        peg$c6 = function(ns) {
        	return {
        		namespace : ns
        	};
        ...
        peg$c15 = /^[a-z_]/i,
        peg$c16 = { type: "class", value: "[a-z_]i", description: "[a-z_]i" },
        peg$c17 = function(SUT, checks) {
        	return {
        		className: SUT.join(""),
        		Methods: checks
        	};
        ...
        peg$c18 = "check",
        peg$c19 = { type: "literal", value: "check", description: "\"check\"" },
        peg$c20 = "that",
        peg$c21 = { type: "literal", value: "that", description: "\"that\"" },
        peg$c22 = function(method, tests) {
        	return {
    ...
    function peg$parsestart() {
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parsetest_namespace();
        if (s2 === peg$FAILED) {
          s2 = peg$c2;
        }
        if (s2 !== peg$FAILED) {
          s3 = peg$parsesystem_under_test();
          if (s3 !== peg$FAILED) {
            peg$reportedPos = s0;
            s1 = peg$c3(s1, s2, s3);
            s0 = s1;
    ...
    function peg$parsetest_namespace() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parsesystem_under_test() {
